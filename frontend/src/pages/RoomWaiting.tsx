  ...
  return (
    <div>
      ...
      <div className="text-center">
        <h1>
          {' '}
          Waiting : You will be redirect when a player will be found, until
          that, you can chat :)
        </h1>
      </div>
      <div className="flex-container">
        <div className="mc-menu">
          <div className="mc-button full">
            <button className="mc-button full" onClick={Pew}>
              {' '}
              PewPew{' '}
            </button>
          </div>
          <div className="mc-button full">
            <button className="mc-button full" onClick={Discord}>
              {' '}
              Discord ?{' '}
            </button>
          </div>
          <div className="mc-button full">
            <button className="mc-button full" onClick={Roh}>
              {' '}
              Thinkge ? PLEASE CLICK ONLY 1 TIMES{' '}
            </button>
          </div>
        </div>
      </div>
