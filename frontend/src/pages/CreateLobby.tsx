      ...
      <div className="flex-container">
        <div className="mc-menu">
          <div className="mc-button full">
            <Nav.Link onClick={addLobby} className="title">
              Create classic Lobby
            </Nav.Link>
          </div>
          <div className="mc-button full">
            <Nav.Link onClick={addRainbowLobby} className="title">
              Create Rainbow Day Lobby
            </Nav.Link>
          </div>
          <div className="mc-button full">
            <Nav.Link onClick={printLobby} className="title">
              Print Lobby
            </Nav.Link>
          </div>
        </div>
